...
namespace XDPaint.Core.PaintObject.Base
{
    public class BasePaintObjectRenderer : IDisposable
    {
        ...
        protected Vector2[] GetLinePositions(Vector2 fistPaintPos, Vector2 lastPaintPos, Triangle firstTriangle, Triangle lastTriangle, int fingerId)
        {
            return lineDrawer.GetLinePositions(fistPaintPos, lastPaintPos, firstTriangle, lastTriangle, fingerId);
        }
