...
namespace XDPaint.Tools.Image.Base
{
    ...
    public abstract class BasePaintTool<T> : IPaintTool where T : BasePaintToolSettings
    {
        ...
        [Obsolete("This property is obsolete, use Settings.CanPaintLines")] public bool CanPaintLines
        {
            get => Settings.CanPaintLines;
            set => Settings.CanPaintLines = value;
        }
        
        [Obsolete("This property is obsolete, use Settings.DrawOnBrushMove")] public bool DrawOnBrushMove
        {
            get => Settings.DrawOnBrushMove;
            set => Settings.DrawOnBrushMove = value;
        }
