...
namespace XDPaint.Tools.Image
{
    ...
    public sealed class GrayscaleTool : BasePaintTool<GrayscaleToolSettings>
    {
        ...
        public override void UpdateHover(PointerData pointerData)
        {
            ...
            if (ShowPreview && (grayscaleData.PrevPaintPosition != pointerData.TexturePosition || grayscaleData.PrevUV != pointerData.UV || grayscaleData.PrevPressure != pointerData.Pressure))
            {
                //render new brush
                var paintOffset = pointerData.TexturePosition;
                ...
                UpdateBrushRenderTexture();
                RenderBrush();
                grayscaleData.PrevUV = pointerData.UV;
                grayscaleData.PrevPaintPosition = pointerData.TexturePosition;
                grayscaleData.PrevPressure = pointerData.Pressure;
            }
        }
